...
struct NewFriendsCardView: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Text("100 Spørgsmål")
                ...
                .font(.footnote)
                .multilineTextAlignment(.leading)
            Text("Samtaler med nye venner fremmer åbenhed, mangfoldighed,fornyelse og mangfoldighed")
                .fontWeight(.semibold)
                .gradientForeground(colors: [.pink, .yellow])
                .font(.body)
                .multilineTextAlignment(.leading)
...
struct NewFriendsCardView_Previews: PreviewProvider {
